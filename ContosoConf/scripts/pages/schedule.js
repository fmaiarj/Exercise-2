...
(function () {
    ...
    var scheduleList = Object.inherit({
        ...
        initialize: function (element, localStartStore) {
            this.element = element;
            this.localStarStore = localStarStorage;
        },

        // Modifications Task2 - Exercise 2
        ...
        downloadDone: function (responseData) {
            this.addAll(reponseData.schedule)
        }
    ...
    // Need Be Deleted (after validation)
